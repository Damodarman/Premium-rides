...
<h3 class="mt-5 text-dark">
<strong>Vrsta ugovornog odnosa sa taxi tvrtkom/obrtom</strong> (molimo označite odgovarajuću vrstu
ugovornog odnosa):
</h3>
</br></br>
...
<div class="container">
  ...
  <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                ...
                <label class="form-check-label h4 mb-0" for="checkbox1" style="max-height: 3em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; width: calc(100% - 0.5in);"><h4>Samozaposleni obrtnik s platformom / Self-employed craft </h4></label>
            </div>            
			<div class="form-check d-flex align-items-center mb-4 ps-0">
				<svg xmlns="http://www.w3.org/2000/svg" width="0.25in" height="0.25in" fill="currentColor" class="bi bi-square me-3" viewBox="0 0 16 16">
  <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                ...
                <label class="form-check-label h4 mb-0" for="checkbox1" style="max-height: 3em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; width: calc(100% - 0.5in);"><h4>Samozaposleni obrtnik s agregatorom / Self-employed craft with an aggregator </h4></label>
            </div>
			<div class="form-check d-flex align-items-center mb-4 ps-0">
				<svg xmlns="http://www.w3.org/2000/svg" width="0.25in" height="0.25in" fill="currentColor" class="bi bi-square me-3" viewBox="0 0 16 16">
  <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
					<?php if($radniOdnos === 'drustvo'){
							echo '<path d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.235.235 0 0 1 .02-.022z"/>';
							} ?>
</svg>
...
Self-employed individual in a trading company – contract with a platform </h4></label>
            </div>
			<div class="form-check d-flex align-items-center mb-4 ps-0">
				<svg xmlns="http://www.w3.org/2000/svg" width="0.25in" height="0.25in" fill="currentColor" class="bi bi-square me-3" viewBox="0 0 16 16">
  <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
