...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="<?php echo base_url()?>">Premium Rides</a></h1>
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
			<div class="dropdown">
			  <li><a class="nav-link dropdown-toggle" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
				Log in/Register
			  </a>
				</li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Better Options For Your Travels and Transfers</h1>
          <h2>We are team of reliable drivers that will get you where you need safe and in time</h2>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              Our mission is to provide the best solution for our clients and our partners/drivers. In assosiation with clients and partners we are improving our services daily.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> We are fast on your location, you will not wait us outside on the raining day.</li>
              <li><i class="ri-check-double-line"></i> In every weather conditions we will drive you safely.</li>
              <li><i class="ri-check-double-line"></i> All our vehicles comply with all safety laws and standards.</li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              We are listening to all suggestions from the clients and partners So we included lot's of features in our service like child seat on demand, free Wi-Fi in vehicle, city tours and many more
            </p>
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
            ...
            <div class="content">
              <h3>Check out our fleet,  <strong>at your disposal</strong></h3>
              <p>
                Vehicle categorys and description:
              </p>
            </div>
            ...
            <div class="accordion-list">
              <ul>
                <li>
                  <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span> Economy <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
                    <p>
                      Small urban cars with capacity for up to 3 people with 1 transport bag. Cars similar to Renault Clio, Ford Fiesta, Opel Corsa, škoda Fabia etc.
                    </p>
                  </div>
                </li>

                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span> Standard <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list">
                    <p>
                      Urban cars with capacity for up to 4 people with 2 transport bags. Cars similar to Renault Megane, Ford Focus, Opel Astra, VW Golf, Škoda Rapid etc.
                    </p>
                  </div>
                </li>

                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed"><span>03</span> Comfort <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-3" class="collapse" data-bs-parent=".accordion-list">
                    <p>
                      Sedans with capacity for up to 4 people with 4 transport bags. Cars similar to Renault Talisman, Ford mondeo, Opel Insignia, VW Passat, Škoda Octavia etc.
                    </p>
                  </div>
                </li>

				<li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-4" class="collapsed"><span>04</span> Premium <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-4" class="collapse" data-bs-parent=".accordion-list">
                    <p>
                      Premium Sedans with capacity for up to 4 people with 4 transport bags. Cars similar to Audi A6, Mercedes E-class, VW Arteon, Škoda Superb and better, etc.
                    </p>
                  </div>
                </li>

				<li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-5" class="collapsed"><span>05</span> Vans <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-5" class="collapse" data-bs-parent=".accordion-list">
                    <p>
                      Vans with capacity for up to 8 people. Vans like Opel Vivaro, Mercedes Vito, Peugeot Partner etc.
                    </p>
                  </div>
                </li>

				<li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-6" class="collapsed"><span>06</span> Premium Vans <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-6" class="collapse" data-bs-parent=".accordion-list">
                    <p>
                      Premium Vans with capacity for up to 8 people. Vans like Mercedes V-Class
                    </p>
                  </div>
                </li>
   ...
   <!-- <section id="skills" class="skills">
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Here you can check what services do we offer</p>
        </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>You can choose us to take care of your transfer from and to Airport anywhere in Croatia and also in a Region</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Transfers between different Cities</a></h4>
              <p>We will take you from any to any other City in a Region</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Holyday Trips</a></h4>
              <p>You wish to visit some Event or Festival and get back? We are here for You</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="">TAXI Farres</a></h4>
              <p>You can choose from 6 different vehicle categorys for your travels in Zagreb, Split, Dubrovnik, Zadar</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Zagreb, 10000<br>
              Croatia <br><br>
              <strong>Phone:</strong> +385 99 641 45 77<br>
              <strong>Email:</strong> info@premium-rides.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Airport Transfers</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Transfers between different Cities</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Holyday Trips</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">TAXI Farres</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="social-links mt-3">
              ...
              <a href="https://www.facebook.com/premium.rides.hr" class="facebook"><i class="bx bxl-facebook"></i></a>
