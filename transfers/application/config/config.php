...
|
*/
$config['encryption_key'] = 'iusdfgsdsadwerugtuyi';
...
$config['sess_cookie_name'] = 'vbsbookingsystem';
$config['sess_expiration'] = 0;

$config['sess_save_path'] = 'vbs_sessions';
...
$csrf_pages = array('payment_success','payment_cancel','payment_failed','payment_canceled');
